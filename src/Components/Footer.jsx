        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-99">Master Your Money, <span className="text-primary font-bold">Live Your Dreams</span></p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                Email:{" "}
                <a className="link link-hover" href="mailto:rukhsathossain2811@gmail.com" target="_blank">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/rukhsat.ruksathossain" target="_blank" className="btn btn-ghost btn-circle">
                <FaFacebookF size={18} />
              </a>
